    ...
    <div class="layout-wrapper">
        ...
        <section id="banner">
            <div class="inner">
                ...
                <appMainSearch :cat="categories"></appMainSearch>   
                <header class="subnote">
        ...
        <div :class="{ hidden: !isHome }" class="main-link-section">
            <div class="inner">
                <h2>Conheces ou encontraste um produto vegano que não consta ainda no Mundo Vegano?</h2>
                <input type="button" id="add-article" name="add-article" @click="redirectCreateProduct()" class="route-button" value="SUBMETER PRODUTO" />
            </div>
        </div>   
