<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Nova Tag</h4>
</div>
{!! Form::open(['action' => ['TagsController@store', $data["tag"]->id], 'method' => 'POST', 'id' => 'tag-form', 'enctype' => 'multipart/form-data', 'id' => 'tag-form']) !!}
    {{ csrf_field() }}
    ...
    <div class="modal-footer">
        ...
        {{Form::button('Gravar', ['class' => 'btn btn-lg  btn-primary', 'id' => 'submit-tag'])}}
    </div>
{!! Form::close() !!}
