        ...
        <div>
            ...
            <div class="widget-body no-padding">
                ...
                <div class="alert alert-info no-margin fade in">
                    ...
                    {{ $data["prices"]->total() . " registos encontrados." }}
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 1%; white-space: nowrap">
                                    <button type="button" class="btn btn-primary editPrice" data-toggle="editRecordModal"  data-id="{{ $price->id }}"  data-post="data-php" data-action="edit">Editar</button>
