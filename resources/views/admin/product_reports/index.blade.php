...
<h2>Denúncias por Validar</h2>
    ...
    <!-- Product Reports Navigation Buttons -->
    <div class="table-nav-area">
        {{ $data["product_reports"]->links() }}
    </div>
    <!-- Widget ID (each widget will need unique ID)-->
    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" >
        <header>
            <span class="widget-icon"> <i class="fa fa-table"></i> </span>
            <h2>Registos de Denúncias</h2>          
        </header>
        ...
        <div>
            ...
            <div class="widget-body no-padding">
                ...
                <div class="alert alert-info no-margin fade in">
                    ...
                    {{ $data["product_reports"]->total() . " registos encontrados." }}
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 1%; white-space: nowrap">
                                    <button type="button" class="btn btn-primary editReport" data-toggle="editRecordModal"  data-id="{{ $product_report->id }}"  data-post="data-php" data-action="edit">Editar</button>
                                    <!--<button class="btn btn-primary" onClick="editRecord" data-record="">Editar</button>-->
                                </td>
                                <td>{{ $product_report->product->name }}</td>
                                <td>{{ $product_report->type->type }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
...
@push('scripts')    
    ...
    <script src="/js/product_report.js"></script>
