...
/***/ "./resources/js/admin/valuelist.js":
/*!*****************************************!*\
  !*** ./resources/js/admin/valuelist.js ***!
  \*****************************************/
/*! no exports provided */
...
var valuelistManager = {
  ...
  validate: function validate() {
    // Clear error styles
    valuelistManager.valuelistForm.find('input, select').removeClass('is-invalid'); // Init Validation
      ...
      if ($('#name').val() != valuelistManager.originalName) {
        ...
        $.ajax({
          ...
          error: function error(xhr, _error) {
            _utils_js__WEBPACK_IMPORTED_MODULE_0__["default"].removeFlash('#' + valuelistManager.modalId + ' .modal-body');
            _utils_js__WEBPACK_IMPORTED_MODULE_0__["default"].addFlash('danger', '#' + valuelistManager.modalId + ' .modal-body', 'Erro ao obter informações de nome.');
          }
        });
      } else {
        valuelistManager.validateLogic();
  ...
  showErrors: function showErrors() {
    ...
    if (!valuelistManager.isValid) {
      for (var i = valuelistManager.valuelistErrorMessageList.length - 1; i >= 0; i--) {
        _utils_js__WEBPACK_IMPORTED_MODULE_0__["default"].addFlash('danger', '#' + valuelistManager.modalId + ' .modal-body', valuelistManager.valuelistErrorMessageList[i]);
      }
    }
  }
};
    ...
    if (this_action == 'edit') {
      ...
      $.get(page + "/loadModal" + "/" + this_id, function (data) {
        ...
        $('#editRecordModal').on('shown.bs.modal', function () {
          ...
          valuelistManager.init();
          valuelistManager.modalId = 'editRecordModal'; // Mark as validation screen
...
/***/ 10:
/*!***********************************************!*\
  !*** multi ./resources/js/admin/valuelist.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\mundovegano\resources\js\admin\valuelist.js */"./resources/js/admin/valuelist.js");
