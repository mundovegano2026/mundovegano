...
var chainManager = {
  ...
  validate: function validate() {
    // Clear error styles
    chainManager.chainForm.find('input, select').removeClass('is-invalid'); // Init Validation
      ...
      if ($('#name').val() != chainManager.originalName) {
        ...
        $.ajax({
          ...
          error: function error(xhr, _error) {
            _utils_js__WEBPACK_IMPORTED_MODULE_0__["default"].removeFlash('#' + chainManager.modalId + ' .modal-body');
            _utils_js__WEBPACK_IMPORTED_MODULE_0__["default"].addFlash('danger', '#' + chainManager.modalId + ' .modal-body', 'Erro ao obter informações de nome.');
          }
        });
      } else {
        chainManager.validateLogic();
  ...
  showErrors: function showErrors() {
    ...
    if (!chainManager.isValid) {
      for (var i = chainManager.chainErrorMessageList.length - 1; i >= 0; i--) {
        _utils_js__WEBPACK_IMPORTED_MODULE_0__["default"].addFlash('danger', '#' + chainManager.modalId + ' .modal-body', chainManager.chainErrorMessageList[i]);
      }
    }
  }
};
...
/***/ 6:
/*!*******************************************!*\
  !*** multi ./resources/js/admin/chain.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\mundovegano\resources\js\admin\chain.js */"./resources/js/admin/chain.js");
